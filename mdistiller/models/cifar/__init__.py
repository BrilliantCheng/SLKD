...
from .wrn import wrn_16_1, wrn_16_2, wrn_40_1, wrn_40_2, wrn_28_4
...
cifar100_model_prefix = os.path.join(
    ...
    "/home/vot/votssd/code/LiTong/mdistiller-master/mdistiller-master/mdistiller/models/cifar/download_ckpts/cifar_teachers//"
)
cifar_model_dict = {
    # teachers
    "resnet56": (
    ...
    "wrn_28_4": (
        wrn_28_4,
        cifar100_model_prefix + "wrn_28_4_vanilla/ckpt_epoch_240.pth",
    ),
