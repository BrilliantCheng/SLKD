...
# Tech_KD Distiller
CFG.DISTILLER.CHILD1 = ""
CFG.DISTILLER.CHILD2 = ""
# Solver
CFG.SOLVER = CN()
CFG.SOLVER.TRAINER = "base"
CFG.SOLVER.TECH_TRAINER = "tech"
...
# Tech_KD CFG
CFG.TECH_KD = CN()
CFG.TECH_KD.TEMPERATURE = 4.0
CFG.TECH_KD.LOSS = CN()
CFG.TECH_KD.LOSS.CE_WEIGHT = 0.1
CFG.TECH_KD.LOSS.KD_WEIGHT = 0.9
CFG.TECH_KD.PROCESS_WEIGHT =  1
CFG.TECH_KD.LOSS.CE_WEIGHT_CS = 1
CFG.TECH_KD.LOSS.KD_WEIGHT_CS = 1
# DFGKD CFG
CFG.DFGKD = CN()
CFG.DFGKD.TEMPERATURE = 10.0
CFG.DFGKD.LOSS = CN()
CFG.DFGKD.LOSS.CE_WEIGHT = 0.1
CFG.DFGKD.LOSS.KD_WEIGHT = 0.9
CFG.DFGKD.PROCESS_WEIGHT = 4